...
void calculateAndSendAverage() {
  ...
  if ((averageR >= 50 || averageR > 100)  && (averageG >= 50 || averageG > 100) && (averageB >= 50 || averageB > 100)) {
    Serial.println("blue");
  }
  
  else if ((averageR >= 150 || averageR > 200)  && (averageG >= 150 || averageG > 200) && (averageB >= 150 || averageB > 200)) {
